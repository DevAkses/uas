            ...
            <div class="px-5" style="padding-top: 90px; padding-bottom: 150px;" >
                ...
                <form class="" role="search">
                    ...
                    <?php foreach( $data['video'] as $video) : ?>
                        <li class="list-group-item my-1 w-75"> <?= $video['video_title']  ?><a class="btn btn-primary float-end " href="<?= BASEURL; ?>/kategori_web/detail/<?= $video['video_id']; ?>" role="button">Nonton Video</a> </li>
