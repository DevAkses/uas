        ...
        <div class="z-1">
            <div class="px-5" style="padding-top: 90px; padding-bottom: 150px;" >
                <div class="px-5 py-2 d-flex ">
                    <h2 class="text-white z-1 fw-bold ">Product Design </h2>
                </div>
                <div class="px-5">
                <form class="" role="search">
                    ...
                    <?php foreach( $data['video'] as $video) : ?>
                        <li class="list-group-item my-1 w-75"> <?= $video['video_title']  ?><a class="btn btn-primary float-end " href="<?= BASEURL; ?>/kategori_product/detail/<?= $video['video_id']; ?>" role="button">Nonton Video</a> </li>
